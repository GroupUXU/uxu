...
function Index(): ReactElement {
  ...
  return (
     ...
     >
       ...
       <SectionListCommentsPhones comments={comments} />
       ...
       <SectionEmpty>
         <p>Platforma <strong>Telbook</strong> to kluczowy gracz na polskim rynku w dziedzinie identyfikacji nieznanych połączeń
           telefonicznych. Oferuje szybkie i skuteczne rozwiązanie pozwalające rozpoznać numer dzwoniącego w ciągu kilku
           sekund. Od momentu swojego debiutu w 2024 roku, <strong>Telbook</strong> stał się niezastąpionym narzędziem dla osób chcących
           ustrzec się przed niechcianymi rozmowami od telemarketerów, ankieterów, czy innych niepożądanych
           dzwoniących.</p>
         <p>Dzięki funkcjonalnościom przypominającym tradycyjną książkę telefoniczną, ale dostępną w formacie online,
           serwis pozwala na błyskawiczne i bezproblemowe zidentyfikowanie dzwoniącego bez potrzeby przeszukiwania
           internetu. Użytkownicy mają możliwość weryfikacji numerów komórkowych, stacjonarnych oraz międzynarodowych.
           Dodatkowo, platforma udostępnia informacje dotyczące usług SMS Premium.</p>
         <p>Co więcej, <strong>Telbook</strong> zgromadził obszerną bazę danych, zapewniając swoim użytkownikom dostęp
           do szerokiego
           zakresu informacji w jednym miejscu. Dzięki temu, nieznane numery telefonów już nie stanowią powodu do
           zmartwień. Serwis oferuje wiedzę na temat praktycznie każdego numeru.</p>
         <p>Warto podkreślić, że korzystanie z serwisu, w tym wyszukiwanie numerów telefonów oraz dostęp do zawartych na
           stronie informacji, jest całkowicie bezpłatne dla wszystkich użytkowników. <strong>Telbook</strong> nie
           wymaga zakładania
           konta, co zapewnia łatwy i szybki dostęp do potrzebnych danych dla każdego, kto chce dowiedzieć się, kto
           próbował się z nim skontaktować.</p>
         <p>Na stronie głównej znajduje się lista ostatnich połączeń oraz komentarzy, co umożliwia bieżące śledzenie
           aktywności numerów. Wyszukiwarka numerów telefonów jest niezwykle intuicyjna - wystarczy wprowadzić numer, by

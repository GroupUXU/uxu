...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articles: Attribute.Relation<'plugin::users-permissions.user', 'manyToMany', 'api::article.article'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCustomerMessageCustomerMessage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::customer-message.customer-message', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::customer-message.customer-message', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
